...
<head>
    ...
    <script type="text/javascript">
        function clickx(){
            window.location.href = "program1.php";
        }
        function clickx2(){
...
<div id="signUp">
    <div>
        ...
        <button type="button" id="program1" class="orange" onclick="clickx()">项目一</button><br><br>
        <button type="button" id="program1" class="orange" onclick="clickx2()">项目二</button>
    </div><br>
</div>
</body>
</html>